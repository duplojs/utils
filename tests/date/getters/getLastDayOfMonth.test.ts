...
describe("getLastDayOfMonth", () => {
	it("returns month end for mid-month date", () => {
		...
		expect(result).toBe(DDate.create("2024-02-29", {
			hour: "23",
			minute: "59",
			second: "59",
			millisecond: "999",
	...
	it("handles thirty-day month", () => {
		...
		expect(result).toBe(DDate.create("2024-04-30", {
			hour: "23",
			minute: "59",
			second: "59",
			millisecond: "999",
	...
	it("use in pipe", () => {
		...
		expect(result).toBe(DDate.create("2021-12-31", {
			hour: "23",
			minute: "59",
			second: "59",
			millisecond: "999",
	...
	it("handles dates before 1970", () => {
		...
		expect(result).toBe(DDate.create("1969-07-31", {
			hour: "23",
			minute: "59",
			second: "59",
			millisecond: "999",
