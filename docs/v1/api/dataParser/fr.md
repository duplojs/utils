...
Pour modifier le comportement par défaut du `DataParser`, ajouter vos propres helpers ou construire une librairie/extension au-dessus, consultez le guide [Comment override les méthodes du DataParser ?](/v1/api/dataParser/howToOverride/fr).
