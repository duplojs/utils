...
prev:
  text: "bigint"
  link: "/v1/api/dataParser/bigint/fr"
next:
  text: "literal"
...
<MonacoTSEditor
  src="/v1/api/dataParser/date/examples/tryout.doc.ts"
  majorVersion="v1"
  height="500px"
/>
...
<MonacoTSEditor
  src="/v1/api/dataParser/date/examples/checkers.doc.ts"
  majorVersion="v1"
  height="500px"
/>
...
<MonacoTSEditor
  src="/v1/api/dataParser/date/examples/extended.doc.ts"
  majorVersion="v1"
  height="450px"
/>
...
- [`nil`](/v1/api/dataParser/nil/fr) - Parser pour les valeurs null/undefined
