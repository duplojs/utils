...
next:
  text: "record"
  link: "/v1/api/dataParser/record/fr"
---
...
<MonacoTSEditor
  src="/v1/api/dataParser/tuple/examples/tryout.doc.ts"
  majorVersion="v1"
  height="550px"
/>
...
- [`templateLiteral`](/v1/api/dataParser/templateLiteral/fr) - Parser pour les chaînes de caractères formatées
