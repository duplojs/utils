...
next:
  ...
  link: "/v1/api/dataParser/howToOverride/fr"
---
...
<MonacoTSEditor
  src="/v1/api/dataParser/coerce/examples/overview.doc.ts"
  majorVersion="v1"
  height="550px"
/>
...
<MonacoTSEditor
  src="/v1/api/dataParser/coerce/examples/dpc.doc.ts"
  majorVersion="v1"
  height="360px"
/>
...
- [`bigint`](/v1/api/dataParser/bigint/fr) - Parser pour les entiers bigint