...
<MonacoTSEditor
  src="/v1/api/dataParser/pipe/examples/tryout.doc.ts"
  majorVersion="v1"
  height="520px"
/>
...
<MonacoTSEditor
  src="/v1/api/dataParser/pipe/examples/extended.doc.ts"
  majorVersion="v1"
  height="560px"
/>
...
- [`transform`](/v1/api/dataParser/transform/fr) - Transformer une valeur après validation d’un `inner`
- [`coerce.*`](/v1/api/dataParser/coerce/fr) - Normaliser les données avant validation stricte
