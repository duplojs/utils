...
<MonacoTSEditor
  src="/v1/api/dataParser/array/examples/tryout.doc.ts"
  majorVersion="v1"
  height="500px"
/>
...
<MonacoTSEditor
  src="/v1/api/dataParser/array/examples/checkers.doc.ts"
  majorVersion="v1"
  height="500px"
/>
...
<MonacoTSEditor
  src="/v1/api/dataParser/array/examples/extended.doc.ts"
  majorVersion="v1"
  height="450px"
/>
...
- [`record`](/v1/api/dataParser/record/fr) - Parser pour les objets
