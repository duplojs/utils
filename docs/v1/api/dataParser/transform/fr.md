...
prev:
  text: "pipe"
  link: "/v1/api/dataParser/pipe/fr"
next:
  text: "refine"
...
<MonacoTSEditor
  src="/v1/api/dataParser/transform/examples/tryout.doc.ts"
  majorVersion="v1"
  height="500px"
/>
...
<MonacoTSEditor
  src="/v1/api/dataParser/transform/examples/extended.doc.ts"
  majorVersion="v1"
  height="420px"
/>
...
- [`record`](/v1/api/dataParser/record/fr) - Parser pour les dictionnaires clé/valeur
- [`recover`](/v1/api/dataParser/recover/fr) - Permet de récupérer d'une erreur en fournissant une valeur de secours
