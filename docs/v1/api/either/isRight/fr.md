...
<MonacoTSEditor
  src="/v1/api/either/isRight/examples/tryout.doc.ts"
  majorVersion="v1"
  height="300px"
/>
...
- [`whenIsRight`](/v1/api/either/whenIsRight/fr) – Exécute un callback uniquement lorsque l'entrée est `Right`.
- [`isLeft`](/v1/api/either/isLeft/fr) – Pendant côté `Left`.
