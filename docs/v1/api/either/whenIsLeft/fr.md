...
<MonacoTSEditor
  src="/v1/api/either/whenIsLeft/examples/tryout.doc.ts"
  majorVersion="v1"
  height="340px"
/>
...
- [`whenIsRight`](/v1/api/either/whenIsRight/fr) – Pendant côté succès.
- [`isLeft`](/v1/api/either/isLeft/fr) – Type guard manuel.
- [`whenHasInformation`](/v1/api/either/whenHasInformation/fr) – Pattern matching sur l'information littérale.
