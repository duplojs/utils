...
<MonacoTSEditor
  src="/v1/api/data-parser/refine/examples/tryout.doc.ts"
  majorVersion="v1"
  height="420px"
/>
...
<MonacoTSEditor
  src="/v1/api/data-parser/refine/examples/object.doc.ts"
  majorVersion="v1"
  height="550px"
/>
...
- [`literal`](/v1/api/data-parser/literal/fr) - Parser pour les valeurs littérales
