...
<MonacoTSEditor
  src="/v1/api/data-parser/optional/examples/tryout.doc.ts"
  majorVersion="v1"
  height="500px"
/>
...
<MonacoTSEditor
  src="/v1/api/data-parser/optional/examples/extended.doc.ts"
  majorVersion="v1"
  height="320px"
/>
...
- [`nullable`](/v1/api/data-parser/nullable/fr) - Permet d'accepter `null` dans un parser
