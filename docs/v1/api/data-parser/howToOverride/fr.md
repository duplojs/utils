...
<MonacoTSEditor
  src="/v1/api/data-parser/howToOverride/examples/plugin.doc.ts"
  majorVersion="v1"
  height="750px"
/>
...
- [`Recover`](/v1/api/data-parser/recover/fr) – Pour intercepter les erreurs côté utilisateur sans override global.
