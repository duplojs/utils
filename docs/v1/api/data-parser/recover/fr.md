...
next:
  text: "coerce.*"
  link: "/v1/api/data-parser/coerce/fr"
---
...
<MonacoTSEditor
  src="/v1/api/data-parser/recover/examples/tryout.doc.ts"
  majorVersion="v1"
  height="520px"
/>
...
<MonacoTSEditor
  src="/v1/api/data-parser/recover/examples/extended.doc.ts"
  majorVersion="v1"
  height="500px"
/>
...
- [`nil`](/v1/api/data-parser/nil/fr) - Parser pour les valeurs null ou undefined
