...
<MonacoTSEditor
  src="/v1/api/common/kind/examples/withClass.doc.ts"
  majorVersion="v1"
  height="900px"
/>
...
<MonacoTSEditor
  src="/v1/api/common/kind/examples/withPorp.doc.ts"
  majorVersion="v1"
  height="900px"
/>
...
<MonacoTSEditor
  src="/v1/api/common/kind/examples/withKind.doc.ts"
  majorVersion="v1"
  height="980px"
/>
...
<MonacoTSEditor
  src="/v1/api/common/kind/examples/use.doc.ts"
  majorVersion="v1"
  height="220px"
/>
...
- [`instanceOf`](/v1/api/common/instanceOf/fr) - Alternative autour de `instanceof`
- [`isType`](/v1/api/common/isType/fr) - Type guards utilitaires
