...
<MonacoTSEditor
  src="/v1/api/common/innerPipe/examples/tryout.doc.ts"
  majorVersion="v1"
  height="400px"
/>
...
- [`pipe`](/v1/api/common/pipe/fr) - Version immédiate qui exécute directement le pipeline
- [`asyncInnerPipe`](/v1/api/common/asyncInnerPipe/fr) - Variante asynchrone qui compose des promesses ou FutureEither
