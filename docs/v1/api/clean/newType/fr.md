...
<MonacoTSEditor
  src="/v1/api/clean/newType/examples/tryout.doc.ts"
  majorVersion="v1"
  height="300px"
/>
...
- applique éventuellement une ou plusieurs [contraintes](/v1/api/clean/constraints/fr)
