...
prev:
  text: "lengthLessThan"
  link: "/v1/api/clean/primitives/operators/lengthLessThan/fr"
next:
  text: "dateLessThan"
  link: "/v1/api/clean/primitives/operators/dateLessThan/fr"
---
...
<MonacoTSEditor
  src="/v1/api/clean/primitives/operators/dateGreaterThan/examples/tryout.doc.ts"
  majorVersion="v1"
  height="340px"
/>
