...
<MonacoTSEditor
  src="/v1/api/array/copyWithin/examples/tryout.doc.ts"
  majorVersion="v1"
  height="320px"
/>
...
- [`fill`](/v1/api/array/fill/fr) - Écrase une plage avec une valeur fixe
- [`set`](/v1/api/array/set/fr) - Change une seule position
