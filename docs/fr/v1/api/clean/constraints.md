...
Les variantes `createWithLarge()` et `createWithLargeOrThrow()` suivent les mêmes règles d'erreur, mais acceptent uniquement le type d'entrée large connu par le handler.
