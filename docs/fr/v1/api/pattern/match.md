...
- [`when`](/fr/v1/api/pattern/when) – Ajoute une garde personnalisée.
- [`otherwise`](/fr/v1/api/pattern/otherwise) – Termine le pipeline avec un fallback.
- [`exhaustive`](/fr/v1/api/pattern/exhaustive) – Force la couverture totale des cas.
