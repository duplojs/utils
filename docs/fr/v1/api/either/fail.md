---
outline: [2, 3]
description: "Retourne un Left<\"fail\", void> : parfait pour signaler un échec sans transporter de données supplémentaires."
prev:
  text: "error"
...
Retourne un `Left<"fail", void>` : parfait pour signaler un échec sans transporter de données supplémentaires.
