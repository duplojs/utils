---
outline: [2, 3]
description: "Construit un Right<\"nullish\"> avec une valeur non-nulle/non-undefined."
prev:
  text: "nullishEmpty"
...
Construit un `Right<"nullish">` avec une valeur non-nulle/non-undefined.
...
`NullishFilled<GenericInput>` représentant un cas « présent ».
