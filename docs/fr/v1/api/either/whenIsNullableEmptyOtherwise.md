---
outline: [2, 3]
description: "Exécute un callback pour les valeurs NullableEmpty et un callback otherwise pour toutes les entrées brutes restantes."
prev:
...
Exécute un callback pour les valeurs NullableEmpty et un callback otherwise pour toutes les entrées brutes restantes.
...
- [`whenIsNullableEmpty`](/fr/v1/api/either/whenIsNullableEmpty) - Même condition sans callback otherwise explicite.
