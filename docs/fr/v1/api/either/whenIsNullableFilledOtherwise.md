---
outline: [2, 3]
description: "Exécute un callback pour les valeurs NullableFilled et un callback otherwise pour toutes les entrées brutes restantes."
prev:
...
Exécute un callback pour les valeurs NullableFilled et un callback otherwise pour toutes les entrées brutes restantes.
...
- [`whenIsNullableFilled`](/fr/v1/api/either/whenIsNullableFilled) - Même condition sans callback otherwise explicite.
