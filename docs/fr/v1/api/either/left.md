...
- [`right`](/fr/v1/api/either/right) – Pendant côté succès.
- [`error`](/fr/v1/api/either/error) – Alias spécialisé basé sur `left("error", value)`.
- [`fail`](/fr/v1/api/either/fail) – Variante `Left` sans payload.
