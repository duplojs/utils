...
Identiques à ceux de [`reduce`](/fr/v1/api/array/reduce), mais l'itération commence par le dernier élément du tableau.  
En particulier :
...
- [`reduce`](/fr/v1/api/array/reduce) - Version gauche → droite
- [`join`](/fr/v1/api/array/join) - Concatène des chaînes avec un séparateur explicite
