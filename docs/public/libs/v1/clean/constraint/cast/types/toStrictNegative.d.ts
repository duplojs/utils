...
export interface ComputedErrorStrictNegativeConstraintCast<GenericConstrainedType extends ConstrainedType, GenericConstrainHandler extends typeof StrictNegative> {
    ...
    ]> extends true ? true : CastConstraintError<GenericConstrainHandler, `constraint ${InferredReferenceValue} is strictly greater than zero`> : never : never;
}
export type ForbiddenBadStrictNegativeCast<GenericConstrainedType extends ConstrainedType, GenericConstrainHandler extends typeof StrictNegative> = ComputedErrorStrictNegativeConstraintCast<GenericConstrainedType, GenericConstrainHandler> extends infer InferredResult ? ResolveConstraintCast<InferredResult, CastConstraintError<GenericConstrainHandler, "no casting possible with strict negative">> : never;
