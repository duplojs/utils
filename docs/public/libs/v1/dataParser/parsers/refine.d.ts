...
type _DataParserCheckerRefine<GenericDefinition extends DataParserCheckerDefinitionRefine, GenericInput extends Parameters<GenericDefinition["theFunction"]>[0] = Parameters<GenericDefinition["theFunction"]>[0]> = (Kind<typeof dataParserCheckerRefineKind.definition> & DataParserCheckerBase<GenericDefinition, GenericInput>);
