...
export interface EligibleChecker<GenericValue extends unknown> {
    base: DataParserChecker<DataParserCheckerDefinition, GenericValue>;
...
export type GetEligibleChecker<GenericValue extends unknown> = EligibleChecker<GenericValue> extends infer InferredResult ? Extract<InferredResult[keyof InferredResult], DataParserChecker<DataParserCheckerDefinition, GenericValue>> : never;
