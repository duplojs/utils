...
export type OnlyLiteralBigInt<GenericValue extends unknown> = bigint extends GenericValue ? ComputedTypeError<"Input must be a literal bigint."> : GenericValue;
export type OnlyLiteralBoolean<GenericValue extends unknown> = boolean extends GenericValue ? ComputedTypeError<"Input must be a literal boolean."> : GenericValue;
