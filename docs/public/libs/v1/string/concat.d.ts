 ...
 * 
 */
export declare function concat<GenericInput extends string>(text: string): (input: GenericInput) => string;
export declare function concat(input: string, ...textsRest: string[]): string;
