 ...
 * 
 */
export declare function matchInformationOtherwise<GenericInput extends unknown, GenericMatcher extends ComputeMatcher<Extract<GenericInput, Either>>, GenericOutput extends unknown>(matcher: (ComputeMatcher<Extract<NoInfer<GenericInput>, Either>> & GenericMatcher), otherwise: (value: Exclude<GenericInput, Kind<typeof informationKind.definition, Extract<GetPropsWithValueExtends<GenericMatcher, AnyFunction>, string>>>) => GenericOutput): (input: GenericInput) => (ReturnType<NoInfer<Extract<GenericMatcher[keyof GenericMatcher], AnyFunction>>> | GenericOutput);
export declare function matchInformationOtherwise<GenericInput extends unknown, GenericMatcher extends ComputeMatcher<Extract<GenericInput, Either>>, GenericOutput extends unknown>(input: GenericInput, matcher: FixDeepFunctionInfer<ComputeMatcher<Extract<GenericInput, Either>>, GenericMatcher>, otherwise: (value: Exclude<GenericInput, Kind<typeof informationKind.definition, Extract<GetPropsWithValueExtends<GenericMatcher, AnyFunction>, string>>>) => GenericOutput): (ReturnType<NoInfer<Extract<GenericMatcher[keyof GenericMatcher], AnyFunction>>> | GenericOutput);
export {};
