...
var whenElse = require('./left/whenElse.cjs');
...
var whenElse$1 = require('./right/whenElse.cjs');
...
exports.whenIsLeftElse = whenElse.whenIsLeftElse;
...
exports.whenIsRightElse = whenElse$1.whenIsRightElse;
