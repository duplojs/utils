...
To change the default behavior of `DataParser`, add your own helpers, or build a library/extension on top of it, see the guide [How to override DataParser methods?](/fr/v1/api/dataParser/howToOverride).
