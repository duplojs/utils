---
outline: [2, 3]
description: "Runs one callback for OptionalEmpty values and an otherwise callback for every remaining raw input."
prev:
...
- [`whenIsOptionalEmpty`](/en/v1/api/either/whenIsOptionalEmpty) - Same condition without an explicit otherwise callback.
