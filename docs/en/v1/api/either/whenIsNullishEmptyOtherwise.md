---
outline: [2, 3]
description: "Runs one callback for NullishEmpty values and an otherwise callback for every remaining raw input."
prev:
...
- [`whenIsNullishEmpty`](/en/v1/api/either/whenIsNullishEmpty) - Same condition without an explicit otherwise callback.
