...
export type RemoveAbstractFromConstructor<
	GenericConstructor extends AnyAbstractConstructor,
> = (
	& (new(...args: ConstructorParameters<GenericConstructor>) => InstanceType<GenericConstructor>)
	& {
