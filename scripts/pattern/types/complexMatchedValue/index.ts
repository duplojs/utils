...
> extends infer InferredPatternValue
	? (
		| ComplexMatchedPrimitive<GenericInput, InferredPatternValue>
		| ComplexMatchedObject<GenericInput, InferredPatternValue>
		| ComplexMatchedArray<GenericInput, InferredPatternValue>
		| ComplexMatchedMaybeAll<GenericInput, GenericPatternValue>
	)
	: never;
