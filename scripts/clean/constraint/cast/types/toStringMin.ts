...
export interface ComputedErrorStringMinConstraintCast<
	GenericConstrainedType extends ConstrainedType,
	GenericConstrainHandler extends StringMinHandlerInternal,
> {
	stringMin: GenericConstrainHandler extends StringMinHandlerInternal<infer InferredConstraintValue>
		? ConstraintNumberValue<GenericConstrainedType, "string-min"> extends infer InferredReferenceValue extends number
...
export type ForbiddenBadStringMinCast<
	GenericConstrainedType extends ConstrainedType,
	GenericConstrainHandler extends StringMinHandlerInternal,
> = ComputedErrorStringMinConstraintCast<
