...
export interface ComputedErrorNumberMaxConstraintCast<
	GenericConstrainedType extends ConstrainedType,
	GenericConstrainHandler extends NumberMaxHandlerInternal,
> {
	negative: GenericConstrainHandler extends NumberMaxHandlerInternal<infer InferredConstraintValue>
		? GenericConstrainedType extends Negative
			...
			: never
		: never;
	strictNegative: GenericConstrainHandler extends NumberMaxHandlerInternal<infer InferredConstraintValue>
		? GenericConstrainedType extends StrictNegative
			...
			: never
		: never;
	numberMax: GenericConstrainHandler extends NumberMaxHandlerInternal<infer InferredConstraintValue>
		? ConstraintNumberValue<GenericConstrainedType, "number-max"> extends infer InferredReferenceValue extends number
...
export type ForbiddenBadNumberMaxCast<
	GenericConstrainedType extends ConstrainedType,
	GenericConstrainHandler extends NumberMaxHandlerInternal,
> = ComputedErrorNumberMaxConstraintCast<
