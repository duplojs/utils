...
export interface ComputedErrorPositiveConstraintCast<
	GenericConstrainedType extends ConstrainedType,
	GenericConstrainHandler extends typeof Positive,
> {
	strictPositive: GenericConstrainedType extends StrictPositive
		? true
		: never;
	numberMin: ConstraintNumberValue<GenericConstrainedType, "number-min"> extends infer InferredReferenceValue extends number
...
export type ForbiddenBadPositiveCast<
	GenericConstrainedType extends ConstrainedType,
	GenericConstrainHandler extends typeof Positive,
> = ComputedErrorPositiveConstraintCast<
