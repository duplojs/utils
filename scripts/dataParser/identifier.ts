import { createKindIdentifier } from "@scripts/common";
import { type DataParser } from "./base";
import { type DataParsersExtended, type DataParsers } from "./types";
 ...
 */
export const identifier = createKindIdentifier<
	DataParser,
	| DataParsers
	| DataParsersExtended
>();
