...
export type DataParserExtendedBaseInit<
	GenericParentConstructor extends DCommon.SimplifyTopLevel<ReturnType<typeof DataParserBase.init>>,
> = (
	& (
		abstract new<
		...
		>(definition: GenericDefinition) => (
			& DataParserBaseExtended<
				...
				GenericInput
			>
			& DCommon.Kind<GenericParentConstructor["specificKindHandler"]["definition"]>
			& {
				checkConstructor<
						...
						& (
							GenericConstructor extends (
								& DCommon.AnyConstructor<[any], (
									...
									& DCommon.Kind<typeof dataParserExtendedKind.definition>
									& DCommon.Kind<GenericParentConstructor["specificKindHandler"]["definition"]>
								)>
								& {
									create(...args: never[]): (
	...
	& {
		[
		Prop in Exclude<
			keyof typeof DataParserBaseExtended,
			DCommon.ClearClassKeys
		>
		]: typeof DataParserBaseExtended[Prop]
	}
	& {
