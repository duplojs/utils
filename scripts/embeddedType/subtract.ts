...
export function subtract(value1: EmbeddedNumber, value2: EmbeddedNumber): EmbeddedNumber;
export function subtract(value1: EmbeddedBigint, value2: EmbeddedBigint): EmbeddedBigint;
